...
namespace EzyPeezy.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,LastName,Email,cell_no")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,LastName,Email,cell_no")] Customer customer)
        {
            if (ModelState.IsValid)
            {
